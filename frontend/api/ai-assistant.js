...
2. אם נמצא יותר משם משפחה אחד מובחן עבור אותו שם פרטי, אסור לבחור אחד מהם באופן שרירותי — יש לעצור ולשאול את המשתמש לבירור (למשל "יש כמה אריה במערכת — מה שם המשפחה?"), ולציין את האפשרויות שנמצאו.
